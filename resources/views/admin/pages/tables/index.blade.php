...
@section('content_header')
    ...
    <h1>Mesas <a href="{{ route('tables.create') }}" class="btn btn-dark"><i class="fas fa-plus"></i></a></h1>
@stop
                    ...
                    @foreach ($tables as $table)
                        <tr>
                            ...
                            <td style="width=10px;">
                                ...
                                <a href="{{ route('tables.show', $table->id) }}" class="btn btn-success"><i class="fas fa-eye"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
