                    ...
                    <div class="card card--col" :id="item.ref" id="Basic">
                        <div class="card__header">
                            ...
                            <div class="card__price"><span class="price-currency mr-2"
                                    ...
                                    x-text="item.price[currentPricing]">{{ number_format($plan->price, 2, ',', '.') }}</span> <span
                        ...
                        <div class="card__features">
                            ...
                            <p class="feature"><svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor"
                                ...
                                </svg> <span x-text="feature">{{ $detail->name }}</span>
                            </p>
                            @endforeach
                        </div>
                        <div class="card__footer text-center my-4"><a href="{{ route('plan.subscription', $plan->url) }}"
